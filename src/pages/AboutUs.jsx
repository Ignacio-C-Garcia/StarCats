...
function AboutUs() {
  return (
    <div className={`${styles.about}`}>
      <NavBar />
      <Container>
        <h1 className={`${styles.title} mt-4`}>Sobre nosotros</h1>
        <Row>
              ...
              <Col>
                <div className="row align-items-center">
                  ...
                  <div className="col-md-6">
                    ...
                    <p>
                      ...
                      earum vero culpa ipsum cupiditate? Totam, deserunt
                      architecto at atque facere assumenda dolorum eos provident
                      veniam? Amet.
                    </p>
                  </div>
                </div>
                <div className="row align-items-center mt-5">
                  <div className="col-md-6">
                    ...
                    <ul>
                      <li>
                        <strong>Innovación:</strong> Abrazamos el cambio y
                        buscamos constantemente nuevas formas de hacer las
                        cosas.
                      </li>
                      <li>
              ...
              <div className="container">
                <div className="row align-items-center">
                  ...
                  <div className="col-md-6">
                    ...
                    <p>
                      Nuestra misión es Lorem ipsum dolor sit amet consectetur
                      adipisicing elit. Sequi asperiores officia soluta
                      accusamus cumque dicta, sunt eaque nihil laboriosam
                      quaerat autem. Minus, illo enim a vitae repellendus cum
                      dicta alias?
                    </p>
                  </div>
                </div>
            ...
            <section id="contact" className="py-5">
              <div className="container">
                ...
                <p className="text-center">
                  ...
                  tener. No dudes en contactarnos en{" "}
